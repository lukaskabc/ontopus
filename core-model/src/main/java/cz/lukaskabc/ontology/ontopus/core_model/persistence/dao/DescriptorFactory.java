...
public class DescriptorFactory {
    ...
    public DescriptorFactory() {
        ...
        controllerDescription = new EntityDescriptor(ControllerDescription_.entityClassIRI.toURI());
        contextToControllerMapping = new EntityDescriptor(ContextToControllerMapping_.entityClassIRI.toURI());
        contextToControllerMapping.addAttributeDescriptor(
                ContextToControllerMapping_.controllers, controllerDescription);
    }
    ...
    public EntityDescriptor controllerDescription() {
