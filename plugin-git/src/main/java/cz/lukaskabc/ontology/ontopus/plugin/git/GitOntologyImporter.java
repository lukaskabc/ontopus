...
@Component
@NullMarked
public class GitOntologyImporter implements OntologyImporter<ImportFormData> {
    ...
    @Override
    public Class<ImportFormData> getImportFormDataClass() {
        return ImportFormData.class;
    }
    ...
    @Override
    public void importOntology(ImportFormData importFormResult) {
