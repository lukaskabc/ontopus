...
public class CoreModelArchitectureTest extends BaseArchitectureTest {
    ...
    static final DescribedPredicate<JavaClass> resideInNonCoreModelPackage =
            resideInAnyPackage(OntopusArchitectureTest.ONTOPUS_PACKAGES).and(not(resideInAnyPackage("..core_model..")));

    @ArchTest
    static final ArchRule coreModelPackagesDoesNotDependOnOtherPackages = noClasses()
            .that()
    ...
    static final ArchRule layersShouldBeStrictlyRespected = layeredArchitecture()
            .consideringOnlyDependenciesInAnyPackage("..core_model..")
    ...
    static final ArchRule noCycles =
            slices().matching("..core_model.(**)").should().beFreeOfCycles();
